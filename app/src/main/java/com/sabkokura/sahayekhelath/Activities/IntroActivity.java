...
public class IntroActivity extends AppCompatActivity {
    ...
    private IntroSlider introSlider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        introSlider = new IntroSlider(this);
        if (!introSlider.isFirstTimeLaunch()) {
            launchHomeScreen();
            finish();
        }
    ...
    private void addBottomDots(int currentPage) {
        ...
        System.out.println("Length of Layout: " + layouts.length);
        System.out.println("Length of Layout: " + dots.length);
...
//            dots[currentPage].setTextColor(colorsActive[currentPage]);
    ...
    private void launchHomeScreen() {
        introSlider.setFirstTimeLaunch(false);
