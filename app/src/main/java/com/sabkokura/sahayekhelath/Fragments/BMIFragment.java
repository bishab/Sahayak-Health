...
import com.sabkokura.sahayekhelath.Adapters.BMIPageAdapter;
...
public class BMIFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //assigning Views
        viewPager = (ViewPager2)view.findViewById(R.id.bmi_viewPager);
        tabLayout = (TabLayout) view.findViewById(R.id.bmi_tablayout);

        BMIPageAdapter adapter = new BMIPageAdapter(getActivity(),getContext().getApplicationContext());
        viewPager.setAdapter(adapter);

        new TabLayoutMediator(tabLayout, viewPager, ((tab, position) -> tab.setText(BMI_TITLES[position]))).attach();
